...
select order_id, customer_id, status from orders where order_date < '20218-01-01'
# 5.
# Viết câu lệnh truy vấn lấy ra tất cả order trong bảng orders:
# Có order date trong năm 2018 và status = 2
select order_id, customer_id, status from orders where order_date >= '20218-01-01' and order_date < '2019-01-01' and status = 2
# 6.
# Viết câu lệnh truy vấn lấy ra tất cả customer trong bảng customers:
